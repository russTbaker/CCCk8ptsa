...
<ul>
    ...
    <li>Send a letter (see sample letter at the back of handbook) in the Friday Folder introducing yourself to the
        parents and ask for a donation of $10.00 for a class enrichment fund to help pay for guest speakers and
        in school, grade level enrichment programs.
    </li>
    <li>Obtain a class email list from the classroom volunteer coordinator. Parents of students can be one of
        your best assets when looking for guest speakers.
    </li>
</ul>
...
<div style="text-decoration:underline">Subject &nbsp;&nbsp;Ideas &nbsp;&nbsp;Month Needed</div>
<br/>
<br/>
...
<p>
    ...
    The speaker may have a career that is relevant to a subject the class is studying (IE: Author, Researcher,
    Firefighter etc.…) or they may have traveled to a specific country the students are studying and can share
    pictures and experiences they had. Usually guest speakers will not be charging a fee and are parents or
    residents of the community who are willing to come in to the school and share their knowledge with the class.
    If you cannot find one who is local you may need to research online to find one that does charge a fee. You
    may be able to set up a Skype presentation using the smart boards in the classroom. Usually Skype
    presentations are less expensive than having someone come to the school. You can find speakers from across
    the country and in some cases the world. To determine which guest speakers are needed for the year fill out
    the Guest Speaker/enrichment Worksheet form in the back of this manual with the teacher. Occasionally the
    teacher may email you with a need that was not discussed at the beginning of the year, feel free to
    accommodate that.
</p>

<div align="center" style="font-weight:bold; text-decoration:underline">Ideas for finding Guest Speakers</div>
<ul>
    <li>Email the parents to see if they or someone they know is willing to come in to the school to share their
        expertise on a relevant topic.
    </li>
    <li>Reach out to the PTSA for help</li>
    <li>Ask for a specific speaker in the schools Friday Flyer or ask the Principal to send out an E blast to the
        parents.
    </li>
    <li>Put a small article in the Mountain Messenger to see if there are members of the community that can help
        or ask for the local churches to see if any of their members can help.
    </li>
    <li>Call or email the local universities, colleges and museums to see if they have someone that can do
        outreach or have kits they loan to schools.
    </li>
    <li>Google speakers for the topics needed. Many of the National Museums do Skype presentations.</li>
</ul>
...
<p>Denver Museum of Science and Nature:<a href="www.dmns.org" target="_blank">www.dmns.org</a>.</p>
<ol>
    <li>Click on Education</li>
    <li>Scroll down to schools and teachers</li>
    <li>Look at programs under &quot;at your school&quot; and &quot;distant learning&quot;</li>
</ol>
<p>The Children’s Museum of Denver:<a href="www.mychildsmuseum.org" target="_blank">www.mychildsmuseum.org</a></p>
<ol>
    <li>Go to &quot;Grow up Stuff&quot;</li>
    <li>Scroll down to &quot;Educators&quot;</li>
    <li>Look at outreach program</li>
</ol>
<p>History of Colorado: <a href="www.historyofcolorado.org" target="_blank">www.historyofcolorado.org</a></p>
<ol>
    <li>Click on educators</li>
</ol>
<p>Denver Art Museum: <a href="www.denverartmuseum.org" target="_blank">www.denverartmuseum.org</a></p>
<ol>
    <li>Click on &quot;School and Teachers&quot;</li>
    <li>Look at virtual classrooms</li>
</ol>
<p>National Park Service: <a href="www.nps.gov" target="_blank">www.nps.gov</a></p>
<ol>
    <li>Click on teachers</li>
    <li>Scroll to distant learning</li>
</ol>
<p>Colorado Parks and wildlife: <a href="www.parks.state.co.us" target="_blank">www.parks.state.co.us</a></p>
<ol>
    <li>Click on education</li>
    <li>Look at teacher resources</li>
    <li>Look at critter crates</li>
</ol>
<p>Denver Zoo: <a href="www.denverzoo.org" target="_blank">www.denverzoo.org</a></p>
<ol>
    <li>Click on education</li>
    <li>Look at community outreach</li>
    <li>Look at schools and Teacher Programs</li>
</ol>
<p>Denver Botanical Gardens: <a href="www.botanicalgardens.org" target="_blank">www.botanicalgardens.org</a></p>
<ol>
    <li>Click &quot;Programs&quot;</li>
    <li>Scroll to &quot;Schools and Teachers&quot;</li>
</ol>
<p>Downtown Aquarium: <a href="www.aquariumresturant.com" target="_blank">www.aquariumresturant.com</a></p>
<ol>
    <li>Click on &quot;Fun & Learning&quot;</li>
    <li>Scroll to &quot;School Programs&quot;</li>
    <li>Scroll to &quot;Outreach Programs&quot;</li>
</ol>
<p>Butterfly Pavilion: <a href="www.butterflies.org" target="_blank">www.aquariumresturant.com</a></p>
<ol>
    <li>Click on education</li>
    <li>Click on &quot;Community Outreach&quot;</li>
</ol>
<p>Google electronic field trips</p>

<p>Look up any Museum in the USA or around the world</p>

<p>Colorado Humanities: <a href="www.coloradohumanities.org" target="_blank">www.coloradohumanities.org</a></p>
<ol>
    <li>Click on programs</li>
    <li>Look at writers in the schools</li>
</ol>
...
<ul>
    ...
    <li>If the teacher says that they will make the call then make sure that you follow up. Our teachers are very
        busy and sometimes struggle to find the time to make the call. You may have to make several reminder
        emails or calls.
    </li>
    <li>If the teacher asks you to set up the guest speaker, you may want to get several dates and times that the
        speaker can come in. Email the teacher with the date, time, speakers name and contact information.
    </li>
    <li>If the speaker has never been to the school before make sure to give them directions, the schools phone
        number (in case of last minute cancelations) and the teachers name and grade.
    </li>
    <li>Email the schools secretary to let her know to expect the guest speaker and if she would direct them to
        the classroom. Give the speaker instructions on how to get into the building (they must use the call box
...
<p>
    ...
    packet that will include an invoice. You can email the PTSA treasurer and make arrangements on how to get
    the invoice to her/him.
</p>
...
<p>As Classroom Enrichment Coordinator(s), I (we) will be working closely with (teacher’s names) to schedule
    ...
    emailing you throughout the year to see if you have any ideas for possible speakers or outside programs
...
<ul>
    <li>Classroom topic</li>
    <li>Name of guest speaker/ enrichment program and contact information</li>
    <li>Cost</li>
    <li>A short entry on how the program went and if the teacher(s) would like to schedule this
        speaker/program again
    </li>
    <li>Example</li>
</ul>
<p>Topic: Science of Motion</p>
